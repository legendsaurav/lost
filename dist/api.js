...
export const getApiBaseUrl = () => {
    ...
    try {
        ...
        const maybe = import.meta?.env?.VITE_BACKEND_URL;
        if (maybe)
            return maybe;
    }
    catch (e) { }
...
export const deleteDepartment = (id) => request(`/api/departments/${encodeURIComponent(id)}`, {
    method: 'DELETE',
});
export const registerPublicUser = (userData) => request('/api/public-register', {
    method: 'POST',
